...
const checkCards = () => {
    ...
    if( firstCharacter === secondCharacter ) {
        ...
        const audio = new Audio('../audio/dragon-ball-z-golpe-soco-forte-luta-strongpunch.mp3')
        audio.play()
...
const cronTimer = () => {
    ...
    const startTimer = () => {
      ...
      currentTimer.innerText = `${(hr > 0 ? (String(hr).padStart(2, '0')) +  ':' : '')}${String(min).padStart(2, '0')}:${String(sec).padStart(2, '0')}`;
    };
